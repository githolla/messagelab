...
import { SENTIMENTS, kindDef, isSocialSubject } from "@/lib/focus";
...
export async function POST(req: NextRequest) {
  ...
  const socialQ = social
    ...
    : "";
  const socialJson = social ? `, "like": true|false, "comment": true|false, "share": true|false` : "";
...
7. quote — one sentence in your own voice summing up your reaction.${socialQ}

Respond with ONLY this JSON (no markdown fences):
{ "sentiment": "...", "likelihood": 1-5, "resonates": "...", "concern": "...", "question": "...", "suggestion": "...", "quote": "..."${socialJson} }`;
  ...
  return NextResponse.json({
    ...
    quote: str(p.quote),
    ...(social ? { like: bool(p.like), comment: bool(p.comment), share: bool(p.share) } : {}),
